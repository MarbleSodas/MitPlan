        ...
        {displayedUsers.map((user) => {
          ...
          return (
            ...
            >
              ...
              <div
                className={`absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-2 py-1 rounded text-xs font-medium pointer-events-none shadow-md transition-all bg-foreground text-card ${isHovered ? 'opacity-100 visible' : 'opacity-0 invisible'}`}
              >
